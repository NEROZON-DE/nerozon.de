...
if(!in_array($action,['prepare','deploy','confirm','rollback'],true)) exit;
if(!in_array($component,['www','api','factory'],true)) exit;
if($component!=='factory'&&in_array($action,['confirm','rollback'],true)) exit;
