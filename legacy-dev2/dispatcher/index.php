...
<section class="panel status-panel"><div class="panel-title"><h2>Queue</h2><span class="subtle"><?=array_sum($counts)?> Jobs gesamt</span></div><div class="queue">
<?php foreach(['queued'=>'Queued','processing'=>'Processing','done'=>'Done','failed'=>'Failed'] as $key=>$label):?><div class="metric"><strong><?=(int)$counts[$key]?></strong><span><?=$label?></span></div><?php endforeach;?>
</div></section>
</div>
...
</div><p><button>Einstellungen speichern</button></p><div class="footnote">Secret-Felder bleiben absichtlich leer. Ein leerer Wert verändert das vorhandene Secret nicht.</div></form></div></details>
</main>
<script>
(() => {
